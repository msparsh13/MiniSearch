...
/**
 * TODO: Objects within objects not being read make them read by inverted index :: fixed
 */
fn main() {
...
attributes.insert("KEY".to_string(), Value::Object(inner_map));
    ...
    trainer_info.insert("team".to_string(), Value::Object({
    ...
    document_data.insert("tournament".to_string(), Value::Text("Indigo League".to_string()));
